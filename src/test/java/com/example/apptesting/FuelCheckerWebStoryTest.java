...
public class FuelCheckerWebStoryTest {
    ...
    public void test_T5() {
        ...
        assertEquals(driver.findElement( By.id("body")).getText().trim(), "Standard tank capacity: 1200 litres.\nHigh safety tank capacity: 800 litres.");
    ...
    public void test_T6() {
        ...
        assertEquals(driver.findElement( By.id("body")).getText().trim(),"Thank you for using FuelChecker." );
    }
}
